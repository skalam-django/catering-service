    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_password', models.CharField(blank=True, max_length=500, null=True)),
                ('user_type', models.CharField(choices=[('admin', 'Admin'), ('employee', 'Employee'), ('vendor', 'Vendor'), ('customer', 'Customer')], default='admin', max_length=255)),
